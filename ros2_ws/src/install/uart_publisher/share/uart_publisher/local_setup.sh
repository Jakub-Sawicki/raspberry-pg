...
: ${AMENT_CURRENT_PREFIX:="/ros2_ws/ros2_ws/src/install/uart_publisher"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/uart_publisher/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/uart_publisher/environment/path.sh"
